...
post_success = 303
get_success = 200
number_site_name = "registrationNumber"
email_site_name = "email"
header_with_code = "Location"

# bs_block
class_with_name = "color-gray text-shadow-white"
class_with_status = "span8 text-shadow-white"
